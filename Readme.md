...
* Make logs better so that it shows what file was moved using "--" and "++" symbols. As well, have all information at the bottom saying how many files are moved from each source.
